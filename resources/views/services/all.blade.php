...
<div class="container-fluid">
    <div class="panel-sub">
        <div class="row">
            <form action="{{ url('service-group-save') }}" method="POST" class="col-xl-14 col-lg-16 col-md-20 col-24-sm col-24">
                {!! csrf_field() !!}
    ...
    <table class="table table-hover">
        ...
        @foreach($serviceGroups as $serviceGroup)
            <tr>
                ...
                <td>
                    <a title="Редактировать" href="{{ url('service-group-form/'.$serviceGroup->id) }}">
                        {{ $serviceGroup->name }}
                    </a>
                </td>
